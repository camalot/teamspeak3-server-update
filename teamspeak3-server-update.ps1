        ...
        try {
            ...
            if ($listItems.Length -gt 1) {
                ...
                foreach ( $group in $groups ) {
                    ...
                    $checksum = (($group.getElementsByClassName("checksum") | select -First 1).innerText -replace "SHA256: ", "").Trim()
                    ...
                    Write-Host "Exists: $((Test-Path -Path $tempPath))";
                    ...
                    Expand-Archive $tempFile $tempPath;
